 ...
 */
public class Category_Posts_Adapter extends ArrayAdapter<Posts> {
    Context mcontext;
    ...
    public Category_Posts_Adapter(Context context, ArrayList<Posts> track123, int count, boolean FROM_DOWNLOAD) {
        super(context, R.layout.list_cat_posts, track123);
        ...
        try {
            ...
            if (count == 0) {
                if (convertView == null || convertView.getTag().equals(TAG_TOP)) {
                    ...
                    convertView = inflater.inflate(R.layout.list_cat_posts, parent, false);
