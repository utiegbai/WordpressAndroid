 ...
 */
public class Explore_Posts_Adapter extends ArrayAdapter<Posts> {
    Context mcontext;
    ...
    private static class ViewHolder {
        TextView txt_track_name, text_name, price_txt;
        ImageView iv_track_image;
        LinearLayout linearlayout_artist;
    }

    public Explore_Posts_Adapter(Context context, ArrayList<Posts> track123, int count, boolean FROM_DOWNLOAD) {
        super(context, R.layout.list_posts_content, track123);
        ...
        try {
            ...
            if (count == 0) {
                if (convertView == null || convertView.getTag().equals(TAG_TOP)) {
                    ...
                    convertView = inflater.inflate(R.layout.list_posts_content, parent, false);
                    ...
                    viewHolder.price_txt = (TextView) convertView.findViewById(R.id.price_txt);
                ...
                String postContent = user1.getPostContent();
                String result = Util.html2text(postContent);

                if (title.equalsIgnoreCase("")) {
                    viewHolder.linearlayout_artist.setVisibility(View.GONE);
                } else {
                    viewHolder.price_txt.setText(result);
